...
open(F, "/home/eddie/Desktop/bitcoinphantom/src/tor/src/app/tor --list-torrc-options |") or die;
while (<F>) {
...
loadTorrc("/home/eddie/Desktop/bitcoinphantom/src/tor/src/config/torrc.sample.in", \%torrcSampleOptions);

# Try to figure out what's in the man page.

my $considerNextLine = 0;
open(F, "/home/eddie/Desktop/bitcoinphantom/src/tor/doc/tor.1.txt") or die;
while (<F>) {
