...
public:
    CMainParams() {
        ...
        consensus.powLimit = uint256S("00000fffff00000000000000000000000000000000000000000000000000000000"); //ArithToUint256(~arith_uint256(0) >> 20);
        consensus.nPowTargetTimespan = 0.1; // diff readjusting time
        consensus.nPowTargetSpacing = 0.1; //
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 50; // 50 out of 100 blocks
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000003eec000004");
        ...
        genesis = CreateGenesisBlock(1412878964, 1473191, 0x3e0fffff, 1);
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x2C, 0x35, 0x47};
        base58Prefixes[EXT_SECRET_KEY] = {0x06, 0x18, 0x16, 0x2D};
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x06, 0x25, 0x57, 0xFD};
        base58Prefixes[EXT_SECRET_KEY] = {0x08, 0x48, 0x88, 0x89};
...
public:
    CRegTestParams() {
        ...
        consensus.nPowTargetTimespan = 3.5 * 12 * 30 * 30; // half a week
        ...
        genesis = CreateGenesisBlock(1462058066, 2, 0x3e0fffff, 1);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x65b4e101cacf3e1e4f3a9237e3a74ffd1186e595d8b78fa8ea22c21ef5bf9347"));
        //assert(genesis.hashMerkleRoot == uint256S("0x768cc22f70bbcc4de26f83aca1b4ea2a7e25f0d100497ba47c7ff2d9b696414c"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x08, 0x48, 0x68, 0xDD};
        base58Prefixes[EXT_SECRET_KEY] = {0x08, 0x58, 0x53, 0x68};
